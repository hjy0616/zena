...
import (
	...
	"github.com/zenanetwork/go-zenanet/consensus/eirene/heimdall/checkpoint"
	"github.com/zenanetwork/go-zenanet/consensus/eirene/heimdall/milestone"
...
func TestFetchWhitelistCheckpointAndMilestone(t *testing.T) {
	...
	// Create a mock heimdall instance and use it for creating a zena instance
	var heimdall mockHeimdall

	zena := &eirene.Zena{HeimdallClient: &heimdall}

	fetchCheckpointTest(t, &heimdall, zena, handler, verifier)
	fetchMilestoneTest(t, &heimdall, zena, handler, verifier)
}
...
func fetchCheckpointTest(t *testing.T, heimdall *mockHeimdall, zena *eirene.Zena, handler *ethHandler, verifier *zenaVerifier) {
	t.Helper()
...
func fetchMilestoneTest(t *testing.T, heimdall *mockHeimdall, zena *eirene.Zena, handler *ethHandler, verifier *zenaVerifier) {
	t.Helper()
