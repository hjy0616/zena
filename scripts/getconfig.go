...
var nameTagMap = map[string]string{
	...
	"\"zena.logs\"":            "zena.logs",
	"url":                     "zena.heimdall",
	"\"zena.without\"":         "zena.withoutheimdall",
	"grpc-address":            "zena.heimdallgRPC",
	"\"zena.runheimdall\"":     "zena.runheimdall",
	"\"zena.runheimdallargs\"": "zena.runheimdallargs",
